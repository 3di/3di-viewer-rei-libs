...
// >> add by zgock for Multilingual start
	//! returns the font
//	virtual IGUIFont* getFont(const c8* filename, u32 fontsize, bool antialias = false, bool transparency = false);
// << add by zgock for Multilingual end
	...
	virtual IGUIProgressBar* addProgressBar(bool horizontal, const core::rect<s32>& rectangle, IGUIElement* parent=0, s32 id=-1);
