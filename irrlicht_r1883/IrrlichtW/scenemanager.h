...
extern "C"
{
    ...
    EXPORT IntPtr SceneManager_AddTerrainSceneNodeFromRawData(IntPtr scenemanager, float* data, int size, int width, IntPtr parent, int id, M_VECT3DF position, M_VECT3DF rotation, M_VECT3DF scale, M_SCOLOR vertexColor,int maxLOD, E_TERRAIN_PATCH_SIZE patchSize, int smoothFactor);
