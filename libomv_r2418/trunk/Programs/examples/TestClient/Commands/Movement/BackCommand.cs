...
namespace OpenMetaverse.TestClient.Commands.Movement
{
    class BackCommand : Command
    {
        ...
        {
            Name = "back";
            Description = "Sends the move back command to the server for a single packet or a given number of seconds. Usage: back [seconds [enable_sparse_update (false|true)]]";
        ...
        {
            if (args.Length > 2)
                return "Usage: back [seconds [enable_sparse_update (false|true)]]";
