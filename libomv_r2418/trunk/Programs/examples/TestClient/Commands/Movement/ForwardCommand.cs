...
namespace OpenMetaverse.TestClient.Commands.Movement
{
    class ForwardCommand : Command
    {
        ...
        {
            Name = "forward";
            Description = "Sends the move forward command to the server for a single packet or a given number of seconds. Usage: forward [seconds [enable_sparse_update (false|true)]]";
        ...
        {
            if (args.Length > 2)
                return "Usage: forward [seconds [enable_sparse_update (false|true)]]";
