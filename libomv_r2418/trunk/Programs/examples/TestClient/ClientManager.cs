...
namespace OpenMetaverse.TestClient
{
    ...
    public class ClientManager
    {
        ...
        public ClientManager(List<LoginDetails> accounts, bool getTextures, bool use3DiLogin)
        {
        ...
        /// <returns></returns>
        public TestClient Login(LoginDetails account, bool use3DiLogin)
        {
            ...
            if (use3DiLogin == true)
            {
                loginStatus = client.Network.Login3Di(loginParams);
            }
            else
            {
                loginStatus = client.Network.Login(loginParams);
            }
            if (loginStatus)
            {
